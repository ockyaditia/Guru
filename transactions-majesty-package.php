...
<body>
	...
	<?php
		...
		$sql_data = "SELECT *, count(*) FROM transactions_majesty WHERE user_code='$user_code' AND package_code='$package_code'";
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="forms">
                            ...
                            <form action="query/transactions-majesty-package.php" method="post" enctype="multipart/form-data">
                                <div class="row">
									<div class="col-12">

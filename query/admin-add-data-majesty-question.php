<?php
	...
	$location = "location:../admin-add-data-majesty-question.php?fail-message=";
	
	include 'upload-file-package.php';
	include 'upload-video-package.php';
	
	// Perform an SQL query
	$sql = "INSERT INTO majesty_question(code, subject, question, answer, option_a, option_b, option_c, option_d, option_e, book, video)
	...
	if (!$result = $mysqli->query($sql)) {
		...
		header('location:../admin-add-data-majesty-question.php?fail='.$mysqli->errno);
	} else {
		...
		header('location:../admin-data-majesty-question.php?success=1');
	}
?>
<?php
	...
	$location = "location:../transactions-package.php?fail-message=";
	
	include 'upload.php';
	
	// Perform an SQL query
	$sql = "INSERT INTO transactions_package(user_code, package_code, payment_code, bank_name, account_name, account_number, img, timestamp)
	...
	if (!$result = $mysqli->query($sql)) {
		...
		header('location:../transactions-package.php?package_code='.$package_code.'&success=1');
	}
?>
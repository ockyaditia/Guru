<?php
	...
	$location = "location:../admin-add-data-tbi.php?fail-message=";
	
	include 'upload-file-package.php';
	include 'upload-video-package.php';
	
	// Perform an SQL query
	$sql = "INSERT INTO tbi_question(code, question, answer, option_a, option_b, option_c, option_d, option_e, book, video)
			values('$code', '$question', '$answer', '$option_a', '$option_b', '$option_c', '$option_d', '$option_e', '$newfilename_pdf', '$newfilename_video')";
	...
	if (!$result = $mysqli->query($sql)) {
		...
		header('location:../admin-add-data-tbi.php?fail='.$mysqli->errno);
	} else {
		...
		header('location:../admin-data-tbi.php?success=1');
	}
?>
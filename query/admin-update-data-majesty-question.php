<?php
	...
	$location = "location:../admin-update-data-majesty-question.php?fail-message=";
	...
	if (basename($_FILES["file_book"]["name"]) == "" && basename($_FILES["file_video"]["name"]) == "") {
		...
		$sql = "UPDATE majesty_question SET
				code='$code',
				subject='$subject',
				question='$question',
				answer='$answer',
	...
	if (!$result = $mysqli->query($sql)) {
		...
		header('location:../admin-data-majesty-question.php?success=2');
	}
?>
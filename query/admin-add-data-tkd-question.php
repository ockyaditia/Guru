<?php
	...
	$location = "location:../admin-add-data-tkd-question.php?fail-message=";
	
	include 'upload-file-package.php';
	include 'upload-video-package.php';
	
	// Perform an SQL query
	$sql = "INSERT INTO tkd_question(code, subject, question, answer, option_a, option_b, option_c, option_d, option_e, book, video)
	...
	if (!$result = $mysqli->query($sql)) {
		...
		header('location:../admin-data-tkd-question.php?success=1');
	}
?>
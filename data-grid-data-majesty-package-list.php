		<table id="data-grid-data-majesty-package-list" class="testgrid">
			<?php
				$sql_column_name = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = '".$dbname."' AND TABLE_NAME = 'majesty_package_list'";
				...
				$sql_data = "SELECT * FROM majesty_package_list WHERE package = '$package'";

...
<body>
	...
	<script>
		function checkAvailability() {
			$("#loader-icon1").show();
			jQuery.ajax({
				url		: "check-availability-update-majesty-package-code.php",
				data	: 'code='+$("#code").val(),
	...
	<?php
		if (isset($_GET['update'])) {
			...
			$sql = "SELECT * FROM majesty_package WHERE code = '$code'";
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="forms">
                            ...
                            <form action="query/admin-update-data-majesty-package.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-12">

		<table id="data-grid-data-transactions-majesty" class="testgrid">
			<?php
				$sql_column_name = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = '".$dbname."' AND TABLE_NAME = 'transactions_majesty'";
				...
				$sql_data = "SELECT * FROM transactions_majesty";
			...
			<tr id="<?php echo $code; ?>">
				...
				<?php
					if ($approval == 1) {
				?>
						<a href="query/admin-update-data-transactions-majesty.php?update=<?php echo $code; ?>&approval=3"><img src="img/core-img/accept.png" alt="Terima" width="25px" height="25px"></a>
						&nbsp;<a href="query/admin-update-data-transactions-majesty.php?update=<?php echo $code; ?>&approval=2"><img src="img/core-img/reject.png" alt="Tolak" width="25px" height="25px"></a>
				<?php
					} else if ($approval == 3) {
				?>
						Sudah Diterima

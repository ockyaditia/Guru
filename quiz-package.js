    ...
    questions.forEach((currentQuestion, questionNumber) => {
      ...
      output.push(
        `<div class="slide">
		   ...
		   <div id="${currentQuestion.code}-book" style="display:none">
				<embed src="pdf/${currentQuestion.book}" width="75%" height="768px" />
		   </div>
		   <br>
		   <br>
  ...
  function showResults() {
    ...
    questions.forEach((currentQuestion, questionNumber) => {
      ...
      if (userAnswer === currentQuestion.correctAnswer) {
		...
		var book = document.getElementById(currentQuestion.code+"-book");
		...
		var quiz_container = document.getElementById("quiz_container");
		quiz_container.style.paddingBottom = "1000px";
      }
    });

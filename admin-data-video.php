...
<head>
	...
	?>
	<script src="js/admin-data-video-grid.js" ></script>
	<!-- [DO NOT DEPLOY] --> <script type="text/javascript">window.onload = function() { editableGrid.onloadHTML("data-grid-data-video"); } </script>
</head>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3>Kelola Data Video</h3>
                    </div>
                </div>
            </div>
			
			<div align="right">
				<a href="admin-add-data-video.php">Tambah Data <img src="img/core-img/new.png" width="50px" height="50px" alt="Tambah Data"></a>
			</div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
						...
						<!-- [DO NOT DEPLOY] --> <?php include("data-grid-data-video.php"); ?>	
						</div>

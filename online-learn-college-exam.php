            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3 style="background-color:#ffc3a0;"><i>#LearnIsChallenge</i></h3>
						<br>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-popular-course mb-100 wow fadeInUp" data-wow-delay="<?php echo $transition; ?>ms">
                        ...
                        <div class="course-content">
                            <a href="online-learn-college-exam-category.php?code=<?php echo $code; ?>"><h4><?php echo $name; ?></h4></a>

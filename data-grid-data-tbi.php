		<table id="data-grid-data-tbi" class="testgrid">
			<?php
				$sql_column_name = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = '".$dbname."' AND TABLE_NAME = 'tbi_question'";
				...
				$sql_data = "SELECT * FROM tbi_question";

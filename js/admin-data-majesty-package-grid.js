...
EditableGrid.prototype.initializeGrid = function() 
{
	with (this) {
		...
		setCellRenderer("action", new CellRenderer({render: function(cell, value) {
			...
			cell.innerHTML = "<a href='admin-data-majesty-package-list.php?add=" + rowId + "'\" style=\"cursor:pointer\">" +
			"<img src=\"" + image("new.png") + "\" width=\"16px\" height=\"16px\" border=\"0\" alt=\"tambah\" title=\"Tambah\"/></a>";

			cell.innerHTML += "&nbsp;<a href='admin-update-data-majesty-package.php?update=" + rowId + "'\" style=\"cursor:pointer\">" +
			"<img src=\"" + image("edit.png") + "\" width=\"16px\" height=\"16px\" border=\"0\" alt=\"ubah\" title=\"Ubah\"/></a>";

			cell.innerHTML += "&nbsp;<a onclick=\"if (confirm('Apakah anda akan menghapus data tersebut? ')) { href='query/admin-remove-data-majesty-package.php?remove=" + rowId + "' } \" style=\"cursor:pointer\">" +

...
<body>
	...
	<script>
		function checkAvailability() {
			$("#loader-icon1").show();
			jQuery.ajax({
				url		: "check-availability-tkd-code.php",
				data	: 'code='+$("#code").val(),
				type	: "POST",
        ...
        <div class="register-contact-form mb-100 wow fadeInUp" data-wow-delay="250ms">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="forms">
                            <h4>Tambah Data Tes Kompetensi Dasar (TKD)</h4>
                            <form action="query/admin-add-data-tkd.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Nama TKD" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">

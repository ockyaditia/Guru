		<table id="data-grid-data-package-list" class="testgrid">
			<?php
				$sql_column_name = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = '".$dbname."' AND TABLE_NAME = 'package_list'";
				...
				$sql_data = "SELECT * FROM package_list WHERE package = '$package'";
			...
			?>
			<tr id="<?php echo $code; ?>">
				<td><div><?php echo $package; ?></div></td>
				<td><div><?php echo $type; ?></div></td>

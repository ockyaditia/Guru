...
<head>
	...
	?>
	<script src="js/admin-data-tkd-grid.js" ></script>
	<!-- [DO NOT DEPLOY] --> <script type="text/javascript">window.onload = function() { editableGrid.onloadHTML("data-grid-data-tkd"); } </script>
</head>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3>Kelola Data Tes Kompetensi Dasar (TKD)</h3>
                    </div>
                </div>
            </div>
			
			<div align="right">
				<a href="admin-add-data-tkd.php">Tambah Data TKD <img src="img/core-img/new.png" width="50px" height="50px" alt="Tambah Data"></a>
			</div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
						...
						<!-- [DO NOT DEPLOY] --> <?php include("data-grid-data-tkd.php"); ?>	
						</div>

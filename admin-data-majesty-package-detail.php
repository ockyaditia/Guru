...
<head>
	...
	?>
	<script src="js/admin-data-majesty-package-detail-grid.js" ></script>
	<!-- [DO NOT DEPLOY] --> <script type="text/javascript">window.onload = function() { editableGrid.onloadHTML("data-grid-data-majesty-package-detail"); } </script>
</head>
...
<body>
    ...
    <section class="popular-courses-area section-padding-100-0" style="background-image: url(img/core-img/texture.png);">
        <div class="container">
			...
			<div align="left">
				<a href="admin-data-majesty-package.php"><img src="img/core-img/back.png" width="75px" height="75px" alt="Kembali"> Kembali</a>
			</div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
						...
						<!-- [DO NOT DEPLOY] --> <?php include("data-grid-data-majesty-package-detail.php"); ?>	
						</div>

...
<head>
	...
	?>
	<script src="js/admin-data-learning-level-menu-grid.js" ></script>
	<!-- [DO NOT DEPLOY] --> <script type="text/javascript">window.onload = function() { editableGrid.onloadHTML("data-grid-data-learning-level-menu"); } </script>
</head>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3>Kelola Data Menu Belajar Online</h3>
                    </div>
                </div>
            </div>
			
			<div align="right">
				<a href="admin-add-data-learning-level-menu.php">Tambah Data <img src="img/core-img/new.png" width="50px" height="50px" alt="Tambah Data"></a>
			</div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
						...
						<!-- [DO NOT DEPLOY] --> <?php include("data-grid-data-learning-level-menu.php"); ?>	

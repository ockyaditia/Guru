...
<head>
	...
	?>
	<script src="js/admin-data-logo-grid.js" ></script>
	<!-- [DO NOT DEPLOY] --> <script type="text/javascript">window.onload = function() { editableGrid.onloadHTML("data-grid-data-logo"); } </script>
</head>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3>Kelola Data Nama dan Logo Web</h3>
                    </div>
                </div>
            </div>

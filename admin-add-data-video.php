...
<body>
	...
	<script>
		function checkAvailability() {
			$("#loader-icon1").show();
			jQuery.ajax({
				url		: "check-availability-video-code.php",
				data	: 'code='+$("#code").val(),
				type	: "POST",
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="forms">
                            ...
                            <form action="query/admin-add-data-video.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-12">
									...
									<div class="col-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="publisher" name="publisher" placeholder="Judul" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
											<input type="file" class="form-control" id="file_name" name="file_name" accept="video/*" required>
                                        </div>
                                    </div>
                                    <div class="col-12">

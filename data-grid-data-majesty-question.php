		<table id="data-grid-data-majesty-question" class="testgrid">
			<?php
				$sql_column_name = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = '".$dbname."' AND TABLE_NAME = 'majesty_question'";
				...
				$sql_data = "SELECT * FROM majesty_question";

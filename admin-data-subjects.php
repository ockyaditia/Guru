...
<head>
	...
	?>
	<script src="js/admin-data-subjects-grid.js" ></script>
	<!-- [DO NOT DEPLOY] --> <script type="text/javascript">window.onload = function() { editableGrid.onloadHTML("data-grid-data-subjects"); } </script>
</head>
...
<body>
    ...
    <section class="popular-courses-area section-padding-100-0" style="background-image: url(img/core-img/texture.png);">
        <div class="container">
			...
			<div align="right">
				<a href="admin-add-data-subjects.php">Tambah Data <img src="img/core-img/new.png" width="50px" height="50px" alt="Tambah Data"></a>
			</div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
						...
						<!-- [DO NOT DEPLOY] --> <?php include("data-grid-data-subjects.php"); ?>	

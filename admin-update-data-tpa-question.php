...
<body>
	...
	<script>
		function checkAvailability() {
			$("#loader-icon1").show();
			jQuery.ajax({
				url		: "check-availability-update-tpa-question-code.php",
				data	: 'code='+$("#code").val(),
	...
	<?php
		if (isset($_GET['update'])) {
			...
			$sql = "SELECT * FROM tpa_question WHERE code = '$code'";
        ...
        <div class="register-contact-form mb-100 wow fadeInUp" data-wow-delay="250ms">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="forms">
                            <h4>Ubah Data Soal TPA</h4>
                            <form action="query/admin-update-data-tpa-question.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-12">
									...
									<div class="col-12">
                                        <div class="form-group">
											<select class="form-control" id="subject" name="subject" required>
												<option value="" disabled selected>Pilih Jenis Soal TPA</option>
												<?php
													require ("config/config.php");
													$sql = "SELECT * FROM tpa";
													if (!$result = $mysqli->query($sql)) {
													...
													while ($data = $result->fetch_assoc()) {
														$subject_tpa = $data['name'] . " - " . $data['description'];
												?>
												<option value="<?php echo $subject_tpa; ?>" <?php if ($subject == $subject_tpa) echo 'selected'; ?>><?php echo $subject_tpa; ?></option>
												<?php
													}
												?>
											</select>

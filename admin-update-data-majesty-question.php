...
<body>
	...
	<script>
		function checkAvailability() {
			$("#loader-icon1").show();
			jQuery.ajax({
				url		: "check-availability-update-majesty-question-code.php",
				data	: 'code='+$("#code").val(),
	...
	<?php
		if (isset($_GET['update'])) {
			...
			$sql = "SELECT * FROM majesty_question WHERE code = '$code'";
        ...
        <div class="register-contact-form mb-100 wow fadeInUp" data-wow-delay="250ms">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="forms">
                            <h4>Ubah Data Soal STAN dan Kedinasan</h4>
                            <form action="query/admin-update-data-majesty-question.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-12">
									...
									<div class="col-12">
                                        <div class="form-group">
											<select class="form-control" id="subject" name="subject" required>
												...
												<option value="STAN" <?php if ($subject == "STAN") echo 'selected'; ?>>STAN</option>
												<?php
												...
												?>
												<option value="<?php echo $code_majesty; ?>" <?php if ($subject == $code_majesty) echo 'selected'; ?>><?php echo $subject_majesty; ?></option>
												<?php
													}
												?>
											</select>

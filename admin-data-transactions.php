...
<head>
	...
	?>
	<script src="js/admin-data-transactions-grid.js" ></script>
	<!-- [DO NOT DEPLOY] --> <script type="text/javascript">window.onload = function() { editableGrid.onloadHTML("data-grid-data-transactions"); } </script>
</head>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
						...
						<!-- [DO NOT DEPLOY] --> <?php include("data-grid-data-transactions.php"); ?>	
						</div>

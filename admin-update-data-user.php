...
<body>
	...
	<script>
		function checkAvailability() {
			$("#loader-icon1").show();
			jQuery.ajax({
				url		: "check-availability-update-user-code.php",
				data	: 'code='+$("#code").val(),
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="forms">
                            ...
                            <form action="query/admin-update-data-user.php" method="post">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Nama" value="<?php echo $name; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
									...
									<div class="col-12">
                                        <div class="form-group">
											<select class="form-control" id="status" name="status" required>
												...
												<option value="Pelajar" <?php if ($status == 'Pelejar') echo 'selected'; ?>>Pelajar</option>
											</select>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="Telepon" value="<?php echo $phone_number; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
